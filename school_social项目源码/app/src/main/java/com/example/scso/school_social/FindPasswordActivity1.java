...
public class FindPasswordActivity1 extends Activity {
        ...
        public void handleMessage(Message msg) {
            switch (msg.arg1) {
                case 0:
                    ...
                    Intent intent=new Intent(FindPasswordActivity1.this,FindPasswordActivity.class);
    ...
    private BootstrapButton bt_getCode;
    private BootstrapButton bt_vertify;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_getCode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(phone.equals("")){
                    Toast.makeText(FindPasswordActivity1.this,"手机号不能为空",Toast.LENGTH_SHORT).show();
                }
                else{
                        if(isMobileNO(phone)){
                            ...
                            Thread thread = new Thread(){
                                public void run(){
                                    String myurl = "http://118.89.199.187/school_social/jsp/get_phone.jsp?phone="+phone;
                                    try {
                        ...
                        Toast.makeText(FindPasswordActivity1.this,"手机号格式错误，请检查",Toast.LENGTH_SHORT).show();
                    }
                }
        ...
        bt_vertify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (code.equals("")){
                    Toast.makeText(FindPasswordActivity1.this,"验证码不能为空",Toast.LENGTH_SHORT).show();
                }else{
            ...
            public void run() {
                if (tag) {
                    while (i > 0) {
                        i--;
                        //如果活动为空
                        if (FindPasswordActivity1.this == null) {
                            break;
                        }

                        FindPasswordActivity1.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
